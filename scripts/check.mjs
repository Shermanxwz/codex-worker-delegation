...
const roots=['src','test','scripts','plugins/codex-worker-delegation/hooks','plugins/codex-worker-delegation/mcp'];
let failed=false;
...
console.log('syntax, shell, and manifest checks passed');
